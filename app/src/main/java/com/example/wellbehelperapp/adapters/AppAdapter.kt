...
abstract class AppAdapter<D : Any, VH : AppViewHolder<D>> : androidx.recyclerview.widget.RecyclerView.Adapter<VH>() {
...
open class AppViewHolder<D : Any>(itemView: View) : androidx.recyclerview.widget.RecyclerView.ViewHolder(itemView),
        LayoutContainer {
